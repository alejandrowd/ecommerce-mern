...
exports.loginUser = catchAsyncErrors(async(req,res,next)=>{
    ...
    // check if password is corect or not
...
// Update / change users password => /api/v1/password/update
...
// update user details on the profile => /api/v1/me/update
...
exports.updateUserByAdmin = catchAsyncErrors(async(req,res)=>{
    const newUserData = {
        name : req.body.name,
        email: req.body.email,
        role: req.body.role
